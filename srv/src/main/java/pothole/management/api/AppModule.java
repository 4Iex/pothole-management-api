package pothole.management.api;
...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("2172382477667895361 pothole-management-api 73cd4e7e-d528-4b18-8a3b-f3e1b7307581 pothole-management-api".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in pothole.management.api package as a set of config entries
        return configLoader.fromResource("pothole/management/api/settings");
    }
