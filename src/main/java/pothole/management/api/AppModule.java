...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("eb6c5a0f-64e0-46ed-a2c8-29446abe7143 -7742788156417563227 pothole-management-api pothole-management-api".getBytes(Charsets.UTF_8));
    }
